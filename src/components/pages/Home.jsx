      ...
      <div className="container-fluid text-light cont-width">
        <div className="row bgc">
          ...
          <div className="row justify-content-around align-items-center  p-5">
            <div className="col-md-5 text-center text-lg-start ">
              ...
              <h6 >
                At <strong>Shree Aaji Restaurant</strong>, we blend timeless
                Indian flavors with a touch of modern elegance. Enjoy soulful
                vegetarian meals made with handpicked ingredients and authentic
                recipes that bring back the joy of traditional home-cooked food.
              </h6>

              <button className="book-btn" onClick={() => navigate('/booktable')}>BOOK TABLE</button>
            </div>
        ...
        <div className="row text-dark p-5">
          ...
          <div className="col-md-6 col-sm-12 marg">
            ...
            <button className="Read-btn" onClick={() => navigate("/about")}>
              Read More
            </button>
          </div>
        </div>
